...
def delete_collection_and_dir(department: str):
    ...
    try:
        ...
        collection_id = collection.database_id  # Chroma automatically assigns this
        ...
        collection_dir = CHROMA_PATH / str(collection_id)
        if collection_dir.exists() and collection_dir.is_dir():
            ...
            print(f"[WARN] Directory not found for collection ID: {collection_dir}")
